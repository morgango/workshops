...
user_prompt_fn = env_values['COMPLETE_USER_PROMPT_FN']
...
instructions_fn = env_values['INSTRUCTIONS_FN']
shots_fn = env_values['SHOTS_FN']
start_fn = env_values['START_FN']
nickname_fn = env_values['NICKNAME_FN']
...
def main():
    ...
    with st.expander("Prompt Options"):
        ...
        with col1:
            ...
            st.session_state['nickname'] = st.text_area("Nickname:", value=nickname_text, height=50, max_chars=None, key=None)
            ...
            instructions_text = get_file_contents('instructions.txt')
            st.session_state['instructions'] = st.text_area("Instructions:", value=instructions_text, height=50, max_chars=None, key=None)
        ...
        with col2:
            ...
            shots_text = get_file_contents('shots.txt')
            st.session_state['shots'] = st.text_area("Shots:", value=shots_text, height=50, max_chars=None, key=None)
            ...
            start_text = get_file_contents('start.txt')
            st.session_state['start'] = st.text_area("Start:", value=start_text, height=50, max_chars=None, key=None)
