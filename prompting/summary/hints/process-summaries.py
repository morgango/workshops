...
def process_files(directory, system_prompt_file, response_file, temperature, model, max_tokens):
...
if __name__ == "__main__":
    ...
    process_files(args.directory, args.system_prompt_file, args.response_directory, args.temperature, args.model, args.max_tokens)
