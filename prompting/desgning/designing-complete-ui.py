...
def main():
    ...
    with st.expander("Prompt Options"):
        ...
        with col1:
            ...
            nickname_text = get_file_contents('nickname.txt')
            nickname = st.text_area("Nickname:", value=nickname_text, height=50, max_chars=None, key=None)
            ...
            instructions = st.text_area("Instructions:", value=instructions_text, height=50, max_chars=None, key=None)
        ...
        with col2:
            ...
            shots = st.text_area("Shots:", value=shots_text, height=50, max_chars=None, key=None)
            ...
            start = st.text_area("Start:", value=start_text, height=50, max_chars=None, key=None)
    ...
    user_prompt = get_file_contents('user-prompt-complete.txt')
